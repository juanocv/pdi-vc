# ----------------------------------------------------------------------------
# Este arquivo foi criado pelo Prof. Paulo Henrique Pisani (UFABC).
# Objetivo: Impedir o uso de funções prontas em Python, incentivando
# a implementação lógica dos algoritmos conforme os requisitos da
# disciplina.
# ----------------------------------------------------------------------------
