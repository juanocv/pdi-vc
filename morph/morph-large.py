...
https://github.com/fzampirolli/pdi-vc/blob/master/morph/morph.py - version 1.1
Last update: May 2026

Morph – Operações morfológicas para Processamento de Imagens.

Este módulo implementa operações como erosão, dilatação, abertura,
fechamento e gradiente morfológico.
"""
